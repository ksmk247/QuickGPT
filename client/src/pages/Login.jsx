    ...
    <form
        ...
        >
            ...
            <div className="mt-5 text-left">
                <a className="text-sm text-purple-500 dark:text-purple-400" href="#" >
                    Forgot password?
                </a>
            </div>
            ...
            <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-3 mb-11">
                ...
                <button type="submit" className="text-purple-500 dark:text-purple-400" onClick={() => setState((prev) => prev === "login" ? "register" : "login")} >
